...
import { generateDbutilsTypeStub } from '../intellisense/dbutilsTypeStubs';
...
/**
 * Databricks preamble with comprehensive type stubs for spark, dbutils, display
 */
...
# Display function for tables/charts
def display(data: Any, *args: Any, **kwargs: Any) -> None: ...

${generateDbutilsTypeStub()}
`;
